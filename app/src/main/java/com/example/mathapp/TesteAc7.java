...
public class TesteAc7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Geo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TesteAc7.this, QuizGeometrie.class);
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedTopicName.isEmpty()) {
                    Toast.makeText(TesteAc7.this, "Vă rugăm să selectați un domeniu", Toast.LENGTH_SHORT).show();
                } else {
                    // Deschide activitatea corespunzătoare domeniului selectat
                    if (selectedTopicName.equals("Radicali")) {
                        // Deschide activitatea Clasa6
                        Intent intent = new Intent(TesteAc7.this, QuizRadicali.class);
                        startActivity(intent);
                    } else if (selectedTopicName.equals("Pitagora")) {
                        // Deschide activitatea Clasa7
                        Intent intent = new Intent(TesteAc7.this, QuizPitagora.class);
                        startActivity(intent);
                    } else if (selectedTopicName.equals("Sin - Cos")) {
                        // Deschide activitatea Clasa8
                        Intent intent = new Intent(TesteAc7.this, QuizSINCOS.class);
                        startActivity(intent);
                    }
                }
            }
