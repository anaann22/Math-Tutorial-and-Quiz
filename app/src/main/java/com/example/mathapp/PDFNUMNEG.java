...
public class PDFNUMNEG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PDFNUMNEG.this, com.example.mathapp.MainActivity.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentPage < pdfView.getPageCount() - 1) {
                    ...
                    Intent intent = new Intent(PDFNUMNEG.this, MainActivity.class);
                    startActivity(intent);
                }
            }
        });
