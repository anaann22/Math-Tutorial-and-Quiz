...
public class QuizRadicali extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_radicali);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizRadicali.this, MainActivity.class);
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswerIndex == -1) {
            ...
            if (currentQuestionIndex < quizItems.size()) {
                ...
                Intent intent = new Intent(QuizRadicali.this, ScoreActivity.class);
