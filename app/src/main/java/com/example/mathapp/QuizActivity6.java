...
public class QuizActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizActivity6.this, MainActivity.class);
    ...
    private void initializeQuizItems() {
        ...
        String question2 = "Care este rezultatul 51 : (-13_?";
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswerIndex == -1) {
            ...
            if (currentQuestionIndex < quizItems.size()) {
                ...
                Intent intent = new Intent(QuizActivity6.this, ScoreActivity.class);
