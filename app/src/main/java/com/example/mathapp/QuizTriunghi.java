...
public class QuizTriunghi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_triunghi);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizTriunghi.this, MainActivity.class);
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswerIndex == -1) {
            ...
            if (currentQuestionIndex < quizItems.size()) {
                ...
                Intent intent = new Intent(QuizTriunghi.this, ScoreActivity.class);
