...
public class QuizGeometrie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_geometrie);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizGeometrie.this, MainActivity.class);
    ...
    private void initializeQuizItems() {
        ...
        String question1 = "Triunghi care are toate laturile egale";
        String[] answers1 = {"echilateral", "dreptunghic", "isoscel", "scalen"};
        int correctAnswerIndex1 = 0;
        quizItems.add(new QuizItem(question1, answers1, correctAnswerIndex1));

        String question2 = "Triunghi care are doua unghiuri de 60 de grade";
        String[] answers2 = {"echilateral", "dreptunghic", "isoscel", "scalen"};
        int correctAnswerIndex2 = 0;
        quizItems.add(new QuizItem(question2, answers2, correctAnswerIndex2));

        String question3 = "Triunghi cu un unghi de 90 de grade";
        String[] answers3 = {"echilateral", "dreptunghic", "isoscel", "scalen"};
        int correctAnswerIndex3 = 1;
        quizItems.add(new QuizItem(question3, answers3, correctAnswerIndex3));

        String question4 = "Teorema unghiului de 30 de grade poate fi aplicata pentru triunghiul ...";
        String[] answers4 = {"echilateral", "dreptunghic", "isoscel", "scalen"};
        int correctAnswerIndex4 = 1;
        quizItems.add(new QuizItem(question4, answers4, correctAnswerIndex4));

        String question5 = "Intr-un triunghi echilateral inaltimea ...";
        String[] answers5 = {"este si mediana", "este si bisectoare", "este mediana si bisectoare", "formeaza unghi de 80 grade"};
        int correctAnswerIndex5 = 2;
        quizItems.add(new QuizItem(question5, answers5, correctAnswerIndex5));

        String question6 = "Triunghi cu doua laturi congruente";
        String[] answers6 = {"echilateral", "dreptunghic", "isoscel", "scalen"};
        int correctAnswerIndex6 = 2;
        quizItems.add(new QuizItem(question6, answers6, correctAnswerIndex6));

        String question7 = "Triunghiul dreptunghic este format din doua catete si ...?";
        String[] answers7 = {"alta cateta", "latime", "lungime", "ipotenuza"};
        int correctAnswerIndex7 = 3;
        quizItems.add(new QuizItem(question7, answers7, correctAnswerIndex7));

        String question8 = "Latura opusa unghiului de 90 grade intr-un triunghi dreptunghic se numeste ...";
        String[] answers8 = {"ipotenuza", "cateta", "mediana", "bisectoare"};
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswerIndex == -1) {
            ...
            if (currentQuestionIndex < quizItems.size()) {
                ...
                Intent intent = new Intent(QuizGeometrie.this, ScoreActivity.class);
